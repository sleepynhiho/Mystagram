...
sealed class Routes(
    ...
    data object AddPostGraph: Routes(name = "AddPostGraph", route = "AddPostGraph")
    data object AddPostScreen: Routes(iconOutlined = R.drawable.add_outlined, name = "AddPost", route = "AddPostGraph/AddPostScreen")
    data object AddPostDetailScreen : Routes(name = "AddPostDetail", route =  "AddPostGraph/AddPostDetailScreen")
