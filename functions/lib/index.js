...
exports.sendNotificationOnNewMessage = functions.firestore
    ...
    if (!chat)
        return null;
    const receiverId = chat.user1Id === messageData.senderId ? chat.user2Id : chat.user1Id;
    const senderImage = chat.user1Id === messageData.senderId
    ...
    try {
        await admin.messaging().send({
            ...
            notification: {
                ...
                imageUrl: notificationData.senderProfileImage
